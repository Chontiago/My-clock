...
class TimeAnimation
  ...
  def options_objects
    ...
    @render_options_text = Text.new(@args, 1, 100, 10, options.keys)
    @options_object ||= AnimationOptions.new(options, @option_select, self)
  end
...
=end
  ...
  def render_options
    ...
    options_object
    @render_options_text.multiple_lines
  end
