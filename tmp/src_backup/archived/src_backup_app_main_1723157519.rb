...
class TimeAnimation
  ...
  def render_time
    ...
    @time_screen_borders ||= Rectangle.new(HALF_SCREEN_WIDTH, HALF_SCREEN_HEIGHT, 10, 10) 
    @time_screen ||= Text.new(@args,@time_screen_borders.x_pos, @time_screen_borders.y_pos + 10, current_time)
