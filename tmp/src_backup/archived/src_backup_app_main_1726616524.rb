...
class TimeAnimation
  ...
  def animation_select_objects
    all_animations = {"Bounce" => @clock_bounce, "Slide" => @clock_slide, "Expand" => @clock_expand, "Color Change" => @clock_color_change}
    @all_animations_text = Text.new(@args, 1, 100, 10, all_animations.keys)
    
    @animation_select ||= AnimationOptions.new(all_animations, @all_animations_text, self)
  end
  ...
  def render_options
    ...
    options_object
    @all_animations_text.multiple_lines
  end
