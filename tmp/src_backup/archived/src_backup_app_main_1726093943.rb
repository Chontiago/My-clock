...
class TimeAnimation
  ...
  def options
    options = {"Bounce" => @clock_bounce, "Slide" => @clock_slide, "Color Change" => @clock_expand, "Color" => @clock_color_change}
  ...
  def option_select
    ...
    @args.outputs.borders << @option_select.hitbox
  ...
  def render_options
    options
    @option_select.draw_multiple_lines

    @option_select.hitbox
