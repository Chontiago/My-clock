...
class TimeAnimation
  ...
  class Bounce
    ...
    def collision(box1, box2) #box1 border, box 2 clock
      ...
      box1.y_pos >= box2.pos + box2.height  #&&
  ...
  def screen_limits(object)
    if collision(@clock, @bottom_border)
      @args.outputs.labels << {x: HALF_SCREEN_WIDTH, y: HALF_SCREEN_HEIGHT, anchor_x: 1.5, anchor_y: 1.5, text:"ahhhhhh"}
    end
