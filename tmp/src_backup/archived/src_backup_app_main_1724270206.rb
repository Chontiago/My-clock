...
class TimeAnimation
  ...
  class Slide
    def initialize(sliding_object, side_bounds)
    ...
    def slide_animation
      ...
      vertical_bounds.each do |bounds|
        if collision(bounds, @sliding_object)
    ...
    def bounds_reached
      ...
      if collision_with_bounds(bounds, @sliding_object)
        @reverse_direction = !@reverse_direction
      end
    end
    
    def collision_with_bounds(bounds, object)
      bounds.each do |bound|
        return collision(bound, object)
      end
