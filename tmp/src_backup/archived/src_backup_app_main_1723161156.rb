...
class TimeAnimation
  ...
  def clock
    ...
    @time_screen_hitbox ||= Rectangle.new(HALF_SCREEN_WIDTH, HALF_SCREEN_HEIGHT, 30, 70) # cambiar valores más adelante 
    @time_screen ||= Text.new(@args,@time_screen_hitbox.x_pos, @time_screen_hitbox.y_pos + 20, current_time)
  end
