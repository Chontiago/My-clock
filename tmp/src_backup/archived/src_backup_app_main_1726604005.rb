...
class TimeAnimation
  ...
  class AnimationOptions
    def initialize(options_hash, options_object)
    ...
    def current_animation
      option_hash.each_pair do |animation_key, animation|
  ...
  def  options_object
    ...
    @options_object ||= AnimationOptions.new(animation_options, @option_select)
  end

  def optons   
    @options_object.option_select
    @options_object.current_animation
  end
=begin
  def option_select #Depende de animation_option 1, depende de mouse_click 1
    ...
    @option_select.clikcked_text.each do |option|
  ...
  def current_animation #Depende de option_select 2, depende de current_animation 0 
    animation_options.each_pair do |animation_key, animation|
