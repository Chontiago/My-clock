...
class TimeAnimation
  ...
  class ColorChange
    ...
    def invert_animation
      if @current_element >= @animated_array.size + 1
  ...
  def element_color_change(element) #Helper function, that makes the animation, takes an array and in a loop sequentially randomizes colors from each element from left to right, and then makes them black again from right to left 
