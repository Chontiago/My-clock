...
class TimeAnimation
  ...
  class Slide
    ...
    def horizontal_limit_allignement
    ...
    def horizontal_movement
      ...
      if @reverse == false 
        ...
        @sliding_object.x_pos = @sliding_object.x_pos - @sliding_onject.width
      end
    ...
    def slide_animation_2
      animation_borders = [@left_border, @right_border, @top_limit, @bottom_limit]
      
      animation_borders.each do |border|
        if collision(border, @sliding_object) && border.bounce_angle == "Vertical"
          @sliding_object.vertical_speed *= REVERSE_TRAYECTORY
          horizontal_movement
        elsif collision(border, @sliding_object) && border.bounce_angle == "Horizontal"
          @reverse = !@reverse
  ...
  def slide_animation
    ...
    @clock_slide_animation.slide_animation_2
